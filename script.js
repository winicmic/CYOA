...
document.getElementById("bruh").innerHTML = "<p>\"Yo, Harry!\" you say as you walk towards him.</p><p>Harry was a pretty chill guy, who got along with most people. He was in your cabin last year, but you didn’t talk to him much. It’s not that you didn’t like him, but you just would have rather talked with your other friends. You still say hi to him now though, just because it’s been so long since you last talked.</p><p>\"Hey, Ben, how’s it been?\" asked Harry.</p><br><input type='radio' name='why' id='good'><label for='good'><h7>\"I’ve been doing pretty good.\"</h7></label><br><input type='radio' name='why' id='better'><label for='better'><h7>\"It could have been better.\"</h7></label><br><input type='button' value='Select' onclick='legoStarwars()'>"
...
let legoBatmanextend = function(){
  document.getElementById("bruh").innerHTML = "<p>You walk back to Harry, and you see that he is talking to Ryan and Daniel. Ryan and Daniel were your cabin-mates last year, and they hang around each other a lot. You are pretty cool with them, but you typically have talked to Daniel more than Ryan.</p><p>\"Hey, there's Ben!\" yells Daniel.</p><p>\"Yo.\"</p><p>\"Hey Ben,\" says Harry. \"We heard you were in our cabin again, so we were going to head over there while we wait for Hunter and Ethan. Are you coming with us?\"</p><input type='radio' name='yeetus' id='staba'><label for='staba'><h7>Stay back</h7></label><br><input type='radio' name='yeetus' id='comwo'><label for='comwo'><h7>Go with them</h7></label><br><input type='button' value='Select'>"
}